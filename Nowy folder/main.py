...
for (index, group) in enumerate(inform.groups_links_list):
    ...
    if index == inform.iter:
        ...
        time.sleep(4)
        pyautogui.moveTo(random_x_y(500, 700), random_x_y(500, 650), 1.5, pyautogui.easeInQuad)
        time.sleep(2)
        ...
        pyautogui.typewrite('/html/body/div[1]/div/div[1]/div/div[5]/div/div/div[3]/div/div/div[1]/div[1]/div/div[3]/div/div/div[1] ')
        time.sleep(2)
